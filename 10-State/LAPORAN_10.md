...
Tambah variabel `plan` dan atribut pada _constructor_-nya seperti berikut.
...
Tambah getter pada `_PlanScreenState` seperti kode berikut.
...
Ubah ke `List` dan mengubah nilai pada `currentPlan`.
...
1. -
2. Navigator.push adalah mekanisme Flutter untuk berpindah halaman (screen/route) dengan cara menumpuk halaman baru di atas halaman lama (stack).
3. ![](attachments/Screen%20Recording%202025-12-19%20092134.gif)
	
	![](attachments/Screen%20Recording%202025-12-19%20093143.gif)
	
	Sekarang, aplikasi planning memiliki menu utama dan menu plan spesifik.